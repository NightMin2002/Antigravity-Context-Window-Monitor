...
function getScript() {
    return `
        (function() {
            ...
            var copiedText = ${JSON.stringify(`✓ ${(0, i18n_1.tBi)('Copied', '已复制')}`)};
            var doneText = ${JSON.stringify(`✓ ${(0, i18n_1.tBi)('Done', '完成')}`)};
            var savedText = ${JSON.stringify(`✓ ${(0, i18n_1.tBi)('Saved', '已保存')}`)};
            var resetText = ${JSON.stringify(`✓ ${(0, i18n_1.tBi)('Reset', '已重置')}`)};
            var openingText = ${JSON.stringify((0, i18n_1.tBi)('Opening...', '正在打开...'))};
            var revealingText = ${JSON.stringify((0, i18n_1.tBi)('Revealing...', '正在定位...'))};
            var openedText = ${JSON.stringify(`✓ ${(0, i18n_1.tBi)('Opened', '已打开')}`)};
            var revealedText = ${JSON.stringify(`✓ ${(0, i18n_1.tBi)('Revealed', '已定位')}`)};
            var openFailedText = ${JSON.stringify((0, i18n_1.tBi)('Open failed', '打开失败'))};
            var revealFailedText = ${JSON.stringify((0, i18n_1.tBi)('Reveal failed', '定位失败'))};
            ...
            function setTabHintState(enabled) {
                ...
                if (badge) {
                    badge.textContent = enabled ? ${JSON.stringify((0, i18n_1.tBi)('Auto Hint Enabled', '自动提示已开启'))} : ${JSON.stringify((0, i18n_1.tBi)('Auto Hint Disabled', '自动提示已关闭'))};
...
//# sourceMappingURL=webview-script.js.map